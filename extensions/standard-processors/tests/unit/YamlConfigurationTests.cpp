...
TEST_CASE("Test YAML Config Processing", "[YamlConfiguration]") {
  ...
  org::apache::nifi::minifi::utils::debug_shared_ptr<core::Repository> testProvRepo = core::createRepository("provenancerepository", true);
  org::apache::nifi::minifi::utils::debug_shared_ptr<core::Repository> testFlowFileRepo = core::createRepository("flowfilerepository", true);
  org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::Configure> configuration = utils::debug_make_shared<minifi::Configure>();
  org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::io::StreamFactory> streamFactory = minifi::io::StreamFactory::getInstance(configuration);
...
TEST_CASE("Test Dependent Property", "[YamlConfigurationDependentProperty]") {
  ...
  org::apache::nifi::minifi::utils::debug_shared_ptr<core::ContentRepository> content_repo = utils::debug_make_shared<core::repository::VolatileContentRepository>();
  core::YamlConfiguration yamlConfig(testProvRepo, testFlowFileRepo, content_repo, streamFactory, configuration);
  const auto component = utils::debug_make_shared<DummyComponent>();
