...
utils::optional<uint64_t> RetryFlowFile::getRetryPropertyValue(const org::apache::nifi::minifi::utils::debug_shared_ptr<FlowFileRecord>& flow_file) const {
...
void RetryFlowFile::setRetriesExceededAttributesOnFlowFile(core::ProcessContext* context, const org::apache::nifi::minifi::utils::debug_shared_ptr<FlowFileRecord>& flow_file) const {
