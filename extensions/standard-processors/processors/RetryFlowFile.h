...
class RetryFlowFile : public core::Processor {
 ...
 private:
  ...
  utils::optional<uint64_t> getRetryPropertyValue(const org::apache::nifi::minifi::utils::debug_shared_ptr<FlowFileRecord>& flow_file) const;
  void setRetriesExceededAttributesOnFlowFile(core::ProcessContext* context, const org::apache::nifi::minifi::utils::debug_shared_ptr<FlowFileRecord>& flow_file) const;
