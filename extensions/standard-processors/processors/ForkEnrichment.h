...
class ForkEnrichment : public core::ProcessorImpl {
 public:
  ...
  EXTENSIONAPI static constexpr const char* Description =
      ...
      "for the "
      "JoinEnrichmentAttributes processor to perform its function. Each incoming FlowFile will be cloned. The original FlowFile will have "
      "appropriate "
      "attributes added and then be transferred to the 'original' relationship. The clone will have appropriate attributes added and then be routed "
