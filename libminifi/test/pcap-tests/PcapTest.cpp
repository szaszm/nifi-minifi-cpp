...
class PcapTestHarness : public IntegrationBase {
 public:
  ...
  void updateProperties(org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::FlowController> fc) {
    auto components = fc->getComponents("pcap");
    for (const auto& component : components) {
      auto proccontroller = dynamic_pointer_cast<minifi::state::ProcessorController>(component);
      if (proccontroller) {
