 ...
 */
class VolatileContentRepository : public core::ContentRepository, public virtual core::repository::VolatileRepository<org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>> {
 public:
  ...
  explicit VolatileContentRepository(std::string name = getClassName<VolatileContentRepository>())
      : core::SerializableComponent(name),
        core::repository::VolatileRepository<org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>>(name),
   ...
   */
  virtual org::apache::nifi::minifi::utils::debug_shared_ptr<io::BaseStream> write(const org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim> &claim, bool append);
  ...
  virtual bool exists(const org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim> &streamId);
 ...
 protected:
  ...
  org::apache::nifi::minifi::utils::debug_shared_ptr<T2> shared_from_parent() {
    return dynamic_pointer_cast<T2>(shared_from_this());
  }
 ...
 private:
  ...
  std::function<bool(org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>, org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>)> resource_claim_comparator_;
  std::function<bool(org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>)> resource_claim_check_;
  std::function<void(org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>)> claim_reclaimer_;
  ...
  std::map<std::string, AtomicEntry<org::apache::nifi::minifi::utils::debug_shared_ptr<minifi::ResourceClaim>>*> master_list_;
