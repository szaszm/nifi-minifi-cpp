...
def transient_flow_with_logondestructionprocessor(context: MinifiTestContext):
    context.get_or_create_default_minifi_container().command = ["/bin/sh", "-c",
...
def processor_with_name_and_property(context: MinifiTestContext, processor_type: str, processor_name: str,
...
@step(
    'an {processor_type} processor with the "{property_name}" property set to "{property_value}" in the "{minifi_container_name}" flow')
@step(
    'a {processor_type} processor with the "{property_name}" property set to "{property_value}" in the "{minifi_container_name}" flow')
def processor_with_property_in_minifi_flow(context: MinifiTestContext, processor_type: str, property_name: str,
                                           property_value: str, minifi_container_name: str):
...
def processor_with_property_in_nifi_flow(context: MinifiTestContext, processor_type: str, property_name: str,
                                         property_value: str):
    processor = Processor(processor_type, processor_type)
    processor.add_property(property_name, property_value)
...
def processor_with_name_in_minifi_flow(context: MinifiTestContext, processor_type: str, processor_name: str,
...
def set_property_of_port_in_rpg(context: MinifiTestContext, property_name: str, port_name: str, rpg_name: str,
                                property_value: str):
    rpg = context.get_or_create_minifi_container(
        DEFAULT_MINIFI_CONTAINER_NAME).flow_definition.get_remote_process_group(rpg_name)
    if not rpg:
...
def set_property_of_processor_in_minifi_flow(context: MinifiTestContext, property_name: str, processor_name: str,
                                             property_value: str, minifi_container_name: str):
...
def set_property_of_processor_in_nifi_flow(context: MinifiTestContext, property_name: str, processor_name: str,
                                           property_value: str):
...
def set_property_of_controller_service(context: MinifiTestContext, property_name: str, controller_name: str,
                                       property_value: str):
...
def connect_relationship_in_minifi_flow(context: MinifiTestContext, relationship_name: str, source: str, target: str,
                                        minifi_container_name: str):
...
def auto_terminate_relationship_in_minifi_flow(context: MinifiTestContext, processor_name: str, relationship: str,
                                               minifi_container_name: str):
    context.get_or_create_minifi_container(minifi_container_name).flow_definition.get_processor(
        processor_name).auto_terminated_relationships.append(relationship)
...
def set_scheduling_period_in_minifi_flow(context: MinifiTestContext, processor_name: str, duration_str: str,
                                         minifi_container_name: str):
    context.get_or_create_minifi_container(minifi_container_name).flow_definition.get_processor(
        processor_name).scheduling_period = duration_str
...
def add_non_sensitive_parameter(context: MinifiTestContext, parameter_name: str, parameter_value: str,
                                context_name: str):
...
def step_impl(context: MinifiTestContext, proxy_type: str, container_name: str):
    controller_service = ControllerService(class_name="ProxyConfigurationService",
                                           service_name="ProxyConfigurationService")
...
def set_processor_event_driven_in_minifi_flow(context: MinifiTestContext, processor_name: str,
                                              minifi_container_name: str):
    processor = context.get_or_create_minifi_container(minifi_container_name).flow_definition.get_processor(
        processor_name)
...
def setup_controller_service_with_property(context: MinifiTestContext, class_name: str, service_name: str,
                                           property_name: str, property_value: str):
...
def setup_controller_service_with_property(context: MinifiTestContext, service_name: str, property_name: str,
                                           property_value: str):
    controller_service = ControllerService(class_name=service_name, service_name=service_name)
    controller_service.add_property(property_name, property_value)
    context.get_or_create_default_minifi_container().flow_definition.controller_services.append(controller_service)
...
def set_processor_property_to_match_attribute(context: MinifiTestContext, property_name: str, processor_name: str,
...
def open_rpg_with_transport_protocol(context: MinifiTestContext, rpg_name: str, address: str, transport_protocol: str):
    context.get_or_create_default_minifi_container().flow_definition.add_remote_process_group(address, rpg_name,
                                                                                              transport_protocol)
...
def nifi_receive_from_rpg_input_port(context: MinifiTestContext, input_port_name: str, rpg_port_name: str,
                                     rpg_name: str):
    input_port_id = context.get_or_create_default_minifi_container().flow_definition.get_input_port_id_of_rpg(rpg_name,
                                                                                                              rpg_port_name)
