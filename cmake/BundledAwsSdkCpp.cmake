...
function(use_bundled_libaws SOURCE_DIR BINARY_DIR)
    ...
    set(AWS_SDK_CPP_PATCH_COMMAND ${Bash_EXECUTABLE} -c "set -x &&\
        ...
        (\"${Patch_EXECUTABLE}\" -d crt/aws-crt-cpp/crt/s2n --remove-empty-files -p1 -R -s -f --dry-run -i \"${S2N_OPENSSL_PATCH}\" || \"${Patch_EXECUTABLE}\" -f -d crt/aws-crt-cpp/crt/s2n/ --remove-empty-files -p1 -N -i \"${S2N_OPENSSL_PATCH}\") &&\
        (\"${Patch_EXECUTABLE}\" -d crt/aws-crt-cpp/crt/aws-c-cal --remove-empty-files -p1 -R -s -f --dry-run -i \"${AWS_C_CAL_OPENSSL_PATCH}\" || \"${Patch_EXECUTABLE}\" -f -d crt/aws-crt-cpp/crt/aws-c-cal --remove-empty-files -p1 -N -i \"${AWS_C_CAL_OPENSSL_PATCH}\") &&\
    :")
