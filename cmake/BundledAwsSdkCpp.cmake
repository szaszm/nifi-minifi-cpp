...
function(use_bundled_libaws SOURCE_DIR BINARY_DIR)
    ...
    if (NOT WIN32 AND NOT APPLE)
        list(APPEND BYPRODUCTS "lib/${PREFIX}s2n.${SUFFIX}")
    endif()
    list(APPEND BYPRODUCTS
            "lib/${PREFIX}aws-checksums.${SUFFIX}"
            "lib/${PREFIX}aws-c-event-stream.${SUFFIX}"
            "lib/${PREFIX}aws-c-s3.${SUFFIX}"
            "lib/${PREFIX}aws-crt-cpp.${SUFFIX}"
            "lib/${PREFIX}aws-c-common.${SUFFIX}"
            "lib/${PREFIX}aws-c-mqtt.${SUFFIX}"
            "lib/${PREFIX}aws-c-io.${SUFFIX}"
            "lib/${PREFIX}aws-c-http.${SUFFIX}"
            "lib/${PREFIX}aws-c-auth.${SUFFIX}"
            "lib/${PREFIX}aws-c-cal.${SUFFIX}"
            "lib/${PREFIX}aws-c-compression.${SUFFIX}"
            "lib/${PREFIX}aws-cpp-sdk-core.${SUFFIX}"
            "lib/${PREFIX}aws-cpp-sdk-s3.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-common PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-common.${SUFFIX}")
    ...
    if (NOT WIN32 AND NOT APPLE)
        ...
        set_target_properties(AWS::s2n PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}s2n.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-io PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-io.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-checksums PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-checksums.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-event-stream PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-event-stream.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-auth PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-auth.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-s3 PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-s3.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-mqtt PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-mqtt.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-http PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-http.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-cal PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-cal.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-c-compression PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-c-compression.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-crt-cpp PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-crt-cpp.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-cpp-sdk-core PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-cpp-sdk-core.${SUFFIX}")
    ...
    set_target_properties(AWS::aws-cpp-sdk-s3 PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/thirdparty/libaws-install/lib/${PREFIX}aws-cpp-sdk-s3.${SUFFIX}")
