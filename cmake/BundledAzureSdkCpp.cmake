...
function(use_bundled_libazure SOURCE_DIR BINARY_DIR)
    ...
    if (WIN32)
        set(SUFFIX "lib")
        set(PREFIX "")
        set(AZURE_CORE_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-core.${SUFFIX}")
        set(AZURE_STORAGE_COMMON_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-storage-common.${SUFFIX}")
        set(AZURE_STORAGE_BLOBS_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-storage-blobs.${SUFFIX}")
        set(AZURE_IDENTITY_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-identity.${SUFFIX}")
        set(AZURE_STORAGE_FILES_DATALAKE_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-storage-files-datalake.${SUFFIX}")
    else()
        set(SUFFIX "a")
        set(PREFIX "lib")
        set(AZURE_CORE_LIB "${INSTALL_DIR}/lib/${PREFIX}azure-core.${SUFFIX}")
